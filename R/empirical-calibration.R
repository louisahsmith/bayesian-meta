...
library(furrr)
library(progressr)
source(here::here("R", "old-R", "redo-calibration-functions.R"))
...
its <- expand_grid(i = which(unique_control_outcomes$outcomeId %in% 
                               # c(23731, 196347, 196625, 433716, 440367, 432513)),
                               c(432513)),
                   t = 9)
