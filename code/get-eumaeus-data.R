...
method_name <- 'CohortMethod' # CaseControl, CohortMethod, HistoricalComparator, SCCS
analysis_id <- 1 # 1:30 (depending on method)
exposure_id <- 211832 # 21184, 21185, 21214, 21215, 211981, 211982, 211983, 211831, 211832, 211833
